(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".template21__slider")) new core(".template21__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
...
***************************************************************************** */
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (targetElement.classList.contains("menu-close") || targetElement.closest(".menu-close")) functions_menuClose();
        if (targetElement.classList.contains("info__button") || targetElement.closest(".menu-info__button")) targetElement.closest(".info").classList.toggle("_active");
        if (!targetElement.closest(".info__button") && document.querySelectorAll(".info._active").length > 0) removeClasses(document.querySelectorAll(".info._active"), "_active");
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        ...
        if (template1) template1.style.setProperty("--header-height", `${mainHeader.offsetHeight}px`);
